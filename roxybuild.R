...
roxy.package(
	...
	pck.description=data.frame(
		...
		Suggests="limma, edgeR, baySeq, NOISeq, MADAM, survcomp, gplots, rjson, qvalue, multicore, Rsamtools, brew, vsn, EDASeq, DESeq, utils, biomaRt, knitr, GenomicRanges, rtracklayer, Repitools",
