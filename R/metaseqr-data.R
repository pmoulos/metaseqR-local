...
#' @title Human RNA-Seq data with three conditions, three samples
#' @description The sample list for \code{hg19.exon.counts}. See the data set description.
...
#' @title Human RNA-Seq data with three conditions, three samples
#' @description The library size list for \code{hg19.exon.counts}. See the data set description.
...
#' @description This data set contains RNA-Seq gene read counts for 3 chromosomes. The data were downloaded from the ENCODE public
#' repository and are derived from the study of Mortazavi et al., 2008 (Mortazavi A, Williams BA, McCue K, Schaeffer L, Wold B. Mapping
#' and quantifying mammalian transcriptomes by RNA-Seq. Nat Methods. 2008 Jul;5(7):621-8). In their experiment, the authors studied
#' among others genes expression at two developmental stages of mouse liver cells. It has two conditions-developmental stages (e14.5,
#' adult_8_weeks) and four samples (e14.5_1, e14.5_2, a8w_1, a8w_2). It also contains a predefined \code{sample.list} and \code{libsize.list}
